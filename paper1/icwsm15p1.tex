...
/Keywords (Social Networks, Data Mining, Social Behaviour, Psycholinguistics, Social Computing)
}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.9\columnwidth]{images/legend.jpg}
\includegraphics[width=0.9\columnwidth]{images/timelines.jpg}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.9\columnwidth]{images/Extraversion_ver1.jpg}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.9\columnwidth]{images/EmotionalStability_ver1.jpg}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.9\columnwidth]{images/Agreeableness_ver1.jpg}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.9\columnwidth]{images/Conscientiousness_ver1.jpg}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.9\columnwidth]{images/OpennessToExperience_ver1.jpg}
...
\multicolumn{2}{c}{Collinearity Statistics} \\
\multicolumn{2}{l}{}                        & Tolerance             & VIF                \\
\hline
1   & (Constant)           & -                     & -                  \\
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.9\columnwidth]{images/fig-x-1.jpg}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.9\columnwidth]{images/fig-x-2.jpg}
\caption{Scatterplot}
